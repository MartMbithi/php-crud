<?php
    ...
    check_login();
        ...
        if(isset($_POST['lostBook']))
        {
            ...
            {
                $success = "Book Returned" && header("refresh:1; url=lost_books.php");
            }
            else 
            {
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Report Lost Book</a></li>
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="form-row mb-4">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="hidden" name="operation_status" required value="3" class="form-control">
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6" style="display:none">
                                                ...
                                                <input type="text" name="operation_type" value="Lost" readonly class="form-control">
                                            </div>
                                            <div class="form-group col-md-6" style="display:none">
                                        ...
                                        <div class="form-row mb-4">
                                            ...
                                            <div class="form-group col-md-6" style="display:none">
                                                ...
                                                <input type="text" value="<?php echo $initialBookCount;?>" required name="book_copies" class="md-input"  />
                                            </div>
                                        </div>
                                        <div class="form-row mb-4">
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="form-row mb-4">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4">Date Reported Lost</label>
                                                <input type="text" value="<?php echo date('m-d-Y')?>" required name="student_operation_end_date"   class="form-control">
                                            </div>
                                        </div>
                                      <button type="submit" name="lostBook" class="btn btn-primary mt-3">Submit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
