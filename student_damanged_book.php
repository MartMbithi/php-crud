<?php
    ...
    check_login();
        ...
        if(isset($_POST['damanged']))
        {
            ...
            {
                $success = "Book Returned" && header("refresh:1; url=damanged_books.php");
            }
            else 
            {
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Return Damanged Book</a></li>
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="form-row mb-4">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="hidden" name="operation_status" required value="4" class="form-control">
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6" style="display:none">
                                                ...
                                                <input type="text" name="operation_type" value="Damanged" readonly class="form-control">
                                            </div>
                                            <div class="form-group col-md-6" style="display:none">
                                      ...
                                      <button type="submit" name="damanged" class="btn btn-primary mt-3">Return Book</button>
                                    </form>
                                </div>
                            </div>
                        </div>
