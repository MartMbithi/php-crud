                    ...
                    <div class="form-content">
                        ...
                        ?>
                            <div class="d-flex user-meta">
                                <?php echo $profilePic;?>
                                <div class="">
                                    <p class=""><?php echo $std->student_email;?></p>
                                </div>
                            </div>
                            <form method="post" class="text-left">
                                <div class="form">
                                    <div id="password-field" class="field-wrapper input mb-2">
                                        ...
                                        <input id="email" style="display:none" name="login_user_name" value="<?php echo $std->student_email;?>" type="email" class="form-control">
