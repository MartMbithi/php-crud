<?php
    ...
    check_login();
        ...
        if(isset($_POST['BorrowBook']))
        {
            ...
            $foregnQry = "INSERT INTO student_operations(student_operation_librarian_id, student_operation_student_id, student_operation_book_id, student_operation_start_date, student_operation_end_date, Student_operation_operation_id) VALUES(?,?,?,?,?,?)";
            ...
            $rc = $foregnStmt->bind_param('iissss', $student_operation_librarian_id, $student_operation_student_id, $book, $student_operation_start_date, $student_operation_end_date, $operation_id);
