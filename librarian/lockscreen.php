                    ...
                    <div class="form-content">
                        <?php
                            ...
                            while($lib = $res->fetch_object())
                            {
                                ...
                                {
                                    $profilePic = "<img src='../assets/img/librarian/$lib->librarian_profile_picture' class='usr-profile' alt='Admin Dpic'>";
                                }
                        ...
                        ?>
                            <div class="d-flex user-meta">
                                <?php echo $profilePic;?>
                                <div class="">
                                    <p class=""><?php echo $lib->librarian_email;?></p>
                                </div>
                            </div>
                            <form method="post" class="text-left">
                                <div class="form">
                                    <div id="password-field" class="field-wrapper input mb-2">
                                        ...
                                        <input id="email" style="display:none" name="login_user_name" value="<?php echo $lib->librarian_email;?>" type="email" class="form-control">
