<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="#lo" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <!--<li class="menu">
                <a href="database_backup.php" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <!--<li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="pr" data-parent="#accordionExample">
                    <li>
                        <a href="add_charges.php"> Add </a>
                    </li>
                    <li>
